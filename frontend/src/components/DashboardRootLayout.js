        ...
        <Box sx={{ display: 'flex' }}>
            ...
            {isMediumUp && (
                <Box 
                    ...
                    <Sidebar open={true} onClose={() => {}} /> {/* Sidebar without drawer behavior */}
                </Box>
            )}
            ...
            <Box sx={{ flexGrow: 1, ml: isMediumUp ? '250px' : 0}}> {/* Add margin-left when sidebar is persistent */}
                ...
                <Box component="main" sx={{ backgroundColor:'secondary.light', height: '100vh', overflow: 'auto', paddingTop: '80px' }}>
                    <Outlet />
                </Box>
            </Box>
        </Box>
